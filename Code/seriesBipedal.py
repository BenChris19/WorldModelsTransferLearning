...
DATA_DIR = "C:/Users/benat/OneDrive/Dokumentuak/World Models CandNo215816/rolloutsBipedal" 
SERIES_DIR = "C:/Users/benat/OneDrive/Dokumentuak/World Models CandNo215816/processed_dataBipedalWalker" 
model_path_name = "C:/Users/benat/OneDrive/Dokumentuak/World Models CandNo215816/VisionBipedal"
...
def ds_gen():
    ...
    for _, fname in enumerate(filenames):
        ...
        if os.stat(file_path).st_size > 0:
          ...
          img = data['obs']
          action = np.reshape(data['action'], newshape=[-1, 4]) 
          reward = data['reward']
          done = data['done']
...
def create_tf_dataset():
    ...
    output_shapes=((1000, 64, 64, 3), (1000, 4), (1000,), (1000,))) 
    return dataset
...
np.savez_compressed(os.path.join(SERIES_DIR, "seriesBipedal.npz"), action=action_dataset, mu=mu_dataset, logvar=logvar_dataset, reward=r_dataset, done=d_dataset)