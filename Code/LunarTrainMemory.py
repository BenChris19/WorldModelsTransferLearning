...
DATA_DIR = "C:/Users/benat/OneDrive/Dokumentuak/World Models CandNo215816/processed_dataLunarLander" 
model_save_path = "C:/Users/benat/OneDrive/Dokumentuak/World Models CandNo215816/data_rnn_lunar" 

if not os.path.exists(model_save_path):
  os.makedirs(model_save_path)

raw_data = np.load(os.path.join(DATA_DIR, "seriesLunar.npz"))
...
initial_z_save_path = "C:/Users/benat/OneDrive/Dokumentuak/World Models CandNo215816/data_rnn_lunar/tf_initial_zFinal"
...
#rnn.set_weights([param_i.numpy() if param_i.numpy().shape != (35,1024) else np.random.rand(34,1024) for param_i in tf.saved_model.load("C:/Users/benat/OneDrive/Dokumentuak/World Models CandNo215816/testjson/tf_rnn").variables])
##########################################################################
