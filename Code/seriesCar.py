...
SERIES_DIR = "C:/Users/benat/OneDrive/Dokumentuak/World Models CandNo215816/processed_dataCarRacing"
model_path_name = "C:/Users/benat/OneDrive/Dokumentuak/World Models CandNo215816/VaeCarRacing"
...
def create_tf_dataset():
    ...
    output_shapes=((1000, 64, 64, 3), (1000, 3), (1000,), (1000,)))
    return dataset
...
np.savez_compressed(os.path.join(SERIES_DIR, "seriesCar.npz"), action=action_dataset, mu=mu_dataset, logvar=logvar_dataset, reward=r_dataset, done=d_dataset)