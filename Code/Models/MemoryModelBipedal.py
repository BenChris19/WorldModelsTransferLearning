...
class BipedalMDNRNN(tf.keras.Model):
    def __init__(self):
        super(BipedalMDNRNN, self).__init__()
        ...
        super(BipedalMDNRNN, self).build((self.rnn_batch_size, self.rnn_max_seq_len, self.rnn_input_seq_width))
