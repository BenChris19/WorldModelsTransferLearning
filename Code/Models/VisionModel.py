...
########################Used for Transfer Learning for the CarRacing-v0 task#######################################
""" vae = OwnVae()
vae.set_weights(tf.keras.models.load_model("C:/Users/benat/OneDrive/Dokumentuak/World Models CandNo215816/notransferVAEBipedal", compile=False).get_weights())

newmodel = vae.model_encoder 
#newmodel.pop()
    ...
    def __init__(self):
        ...
        self.inference_net_base = tf.keras.Sequential(
            ...
            tf.keras.layers.Conv2D(
              ...
              name="enc_conv4"),
            tf.keras.layers.Flatten()]) #newmodel
