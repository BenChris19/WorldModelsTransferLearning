...
from Models.LunarControllerModel import make_controller

dir_name = 'C:/Users/benat/OneDrive/Dokumentuak/World Models CandNo215816/rolloutsLunar'
if not os.path.exists(dir_name):
    os.makedirs(dir_name)


controller = make_controller()
env = make_env(gym_env = "LunarLander-v2",dream_env=False, full_episode=False, load_model=False)
